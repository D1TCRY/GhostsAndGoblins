...
class Sprite:
    """Rappresenta un riquadro di immagine all interno di una texture.

    Memorizza percorso dell immagine, coordinate di origine, dimensioni
    e stato di blinking, fornendo anche proprieta derivate come pos e size.
    """
