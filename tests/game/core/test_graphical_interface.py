...
class GraphicalInterfaceTest(unittest.TestCase):
    ...
    def test_render_sprites_collects_gui_components_from_actors(self):
        ...
        # -> patcho draw_image perché non è rilevante qui
        with patch("src.g2d_lib.g2d.draw_image", return_value=None):
            gi.render_sprites(game)

        # -> accesso al campo privato attraverso name-mangling
    ...
    def test_render_guis_draws_rect(self):
        ...
        self.gui.gui = [comp]  # -> lista di GUIComponent principale
        # -> nessun gui degli attori
        self.gui._GraphicalInterface__gui_actors_components = []  # type: ignore

        with patch("src.g2d_lib.g2d.set_color") as mock_color, \
    ...
    def test_render_calls_camera_and_subrenders(self):
        ...
        with patch.object(gi, "render_background") as mock_bg, \
        ...
        mock_spr.assert_called_once_with(game)
