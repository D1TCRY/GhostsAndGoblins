...
class SpriteCollection:
    """Gestisce una collezione di sprite indicizzati da azione e direzione.

    Fornisce accesso tipo dizionario alla coppia (Action, Direction),
    normalizzando i valori in liste di Sprite e offrendo metodi per
    aggiungere, rimuovere e interrogare gli sprite.
    """

    def __init__(self, sprites: dict[Action, dict[Direction, Sprite | list[Sprite]]] | None = None) -> None:
